...
=== Starting a Job ===
Jobs are started by a JobLauncher. The JobLauncher uses parameters.
In this project the jobs are started through a web service call. The
web service is implemented in a controller which accepts parameters.
